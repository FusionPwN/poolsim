...
- When writing tests that access pivot table properties in Eloquent relationships, always use $model->getRelation('pivot')->property instead of direct property access (e.g., $model->pivot->property). This avoids PHPStan/Larastan property access warnings and ensures type safety in tests and model code.
