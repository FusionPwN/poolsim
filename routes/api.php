...
Route::middleware('auth:sanctum')->group(function () {
	...
	Route::group(['prefix' => 'tournaments'], function () {
		...
		Route::group(['prefix' => '{tournament}/games'], function () {
			Route::get('/', [TournamentsController::class, 'games'])->name('api.tournament.games.index');
		...
		Route::group(['prefix' => '{tournament}/players'], function () {
			Route::get('/', [TournamentsController::class, 'players'])->name('api.tournament.players.index');
